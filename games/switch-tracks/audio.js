...
export function playSwitch() {
  tone({ type: 'square', freqStart: 520, freqEnd: 520, dur: 0.05, peak: 0.07 });
}

export function playGo() {
  // little train whistle: two quick toots
  tone({ type: 'triangle', freqStart: 740, freqEnd: 740, dur: 0.14, peak: 0.12 });
  tone({ type: 'triangle', freqStart: 880, freqEnd: 880, dur: 0.22, peak: 0.12, delay: 0.16 });
}
...
export function playWrong() {
  // gentle "hmm", not a failure buzz — the rider just heads back
  tone({ type: 'sine', freqStart: 360, freqEnd: 300, dur: 0.18, peak: 0.08 });
}
