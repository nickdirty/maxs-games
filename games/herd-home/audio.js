...
export function playSlide() {
  tone({ type: 'sine', freqStart: 380, freqEnd: 240, dur: 0.16, peak: 0.07 });
}
...
export function playCapture(stagger = 0) {
  tone({ type: 'triangle', freqStart: 660, freqEnd: 660, dur: 0.10, peak: 0.12, delay: stagger });
  tone({ type: 'triangle', freqStart: 880, freqEnd: 880, dur: 0.16, peak: 0.12, delay: stagger + 0.09 });
}
