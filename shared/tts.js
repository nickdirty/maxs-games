...
// Falls back to silence on unsupported browsers. The selected voice is
// shared across games (one kid, one voice) and persisted here.

const VOICE_KEY = 'maxs-games:tts:voice';

let selectedVoiceName = null;
try { selectedVoiceName = localStorage.getItem(VOICE_KEY); } catch { /* disabled */ }
